...
\citep{Verbesselt2009a,Verbesselt:2010wo}, and (4) short-term inconsequential change driven by ephemeral weather-related factors such as a rainfall event affecting spectral properties of the soil back ground, or light frost damaging leaves of trees \citep{Vogelmann:2012hm}. Short-term inconsequential changes are often seen as noise depending on the spatial, spectral, and temporal characteristics of the remotely sensed data. This paper focuses on abrupt ecosystem changes further referred to as ecosystem disturbances. 
