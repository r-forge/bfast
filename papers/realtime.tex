...
The potential use of the real-time monitoring approach is demonstrated using real MODIS NDVI satellite image time series. To enable comparison with available in-situ forest inventory data the period from 2000 until end of 2005 was considered as the history period and the year 2006 as the monitoring period. The timing of the detected abrupt changes in the monitoring period (i.e. 2006) revealed were discussed in relation to the noise level and seasonal amplitude and interpreted using in-situ forest inventory data available for 2006 \citep{Verbesselt2009}. 
...
%The signal-to-noise ratio of the 16-day MODIS NDVI image series was derived by using the STL method.
