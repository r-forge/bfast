...
%\begin{figure}
%\centering
% \subfloat[][] {\includegraphics[width=0.5\textwidth]{figs/MedianNDVI_Somalia.eps} } %
% \subfloat[][] {\includegraphics[width=0.5\textwidth]{figs/LengthHistoryPeriod_EA.png} } 
% \subfloat[][] {\includegraphics[width=0.5\textwidth]{figs/Noise_EA.png} } %
% \subfloat[][] {\includegraphics[width=0.5\textwidth]{figs/MagnAbnormalBreak_201012_EA.png} }
% \caption{test}
% \label{fig:spatial}
%\end{figure}
