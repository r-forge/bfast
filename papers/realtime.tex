...
\begin{figure}
\centering
 \subfloat[][] {\includegraphics[width=0.55\textwidth]{figs/MedianNDVI_Somalia.eps} } %
 \subfloat[][] {\includegraphics[width=0.55\textwidth]{figs/LengthHistoryPeriod_EA.eps} }  \\
 \subfloat[][] {\includegraphics[width=0.55\textwidth]{figs/Noise_EA.eps} } %
\subfloat[][] {\includegraphics[width=0.55\textwidth]{figs/MagnAbnormalBreak_201012_EA.eps} }
...
\centering
  ...
  \caption{
 Results of real-time monitoring approach applied to 16-day MODIS NDVI time series for three locations a, b, and c, which correspond to symbols $+,~\triangle$~and~$\diamondsuit$, respectively shown in Fig.~\ref{fig:spatial}}.
