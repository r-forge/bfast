...
significant disturbances occur. The method described in this study are available in the \emph{bfast} package for R \citep{R} from CRAN (\url{http://cran.r-project.org/package=bfast})
...
software environment and is freely available on \url{http://bfast.r-forge.r-project.org/} . The methods are available in the \emph{bfast} package for \emph{R} \citep{R} from CRAN (\url{http://CRAN.R-project.org/package=bfast})
