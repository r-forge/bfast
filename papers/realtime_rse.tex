...
\item Fig.~\ref{fig:spatial}b illustrates the spatial variation of the length of the stable history period and is used to restrict the analysis to regions
...
verifies whether or not a structural change is occurring while stepwise going back in history. The length of the stable history (Fig.~\ref{fig:spatial}b)
